...
print("\nPara descobrir em qual página abrir pense em número o qual o dobro do seu antecessor, menos 3 é igual a 79:")
print("a) 37")
print("b) 51")
print("c) 52")
print("d) 42")
